...
public class YiluTest1 {
    ...
    public static void main(String args[]) {
        Assert.assertEquals(Optional.empty(), firstNonRepeatedChar(null)); // null string
        Assert.assertEquals(Optional.empty(), firstNonRepeatedChar("")); // empty string
        Assert.assertEquals(Optional.empty(), firstNonRepeatedChar("testertester")); // no unique char
        Assert.assertEquals(Optional.of('T'), firstNonRepeatedChar("yiluTestyilu"));
        Assert.assertEquals(Optional.of('e'), firstNonRepeatedChar("testingNonChar"));

        // failed attempt with string index and substring
        Assert.assertEquals(true, isRotated("Tarun", "arunT"));
        ...
        Assert.assertEquals(true, isRotated("TestingRotation", "RotationTesting"));

        // string joining
        Assert.assertEquals(true, isRotated_ByStringJoin("DhraikDka", "DkaDhraik"));
        Assert.assertEquals(false, isRotated_ByStringJoin("Tarun", "anuRt"));
        Assert.assertEquals(false, isRotated_ByStringJoin("Yilu", null));
        Assert.assertEquals(false, isRotated_ByStringJoin("Yilu", "Test"));
    }
    ...
    */
    ...
    static void reduce_map_flatMap() {
        ...
        */
        Assert.assertEquals(new Integer(15), numbers.stream().reduce(0, Integer::sum));
